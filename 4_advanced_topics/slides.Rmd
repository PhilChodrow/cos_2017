...
subtitle: "Session 4 of Computing in Optimization and Statistics, 2017"
author: "Phil Chodrow"
...
**Data frames are the fundamental unit of data science**. Their columns come in one of two types: 

- **Atomic vectors** are vectors of integers, doubles, characters, logical, etc.
- **List columns:** are lists, **and can hold anything.**

## Well if you love lists and data frames so much... {.smaller}
...
Here's a function that extracts the largest price from a data frame:
...
Use `map` to extract the largest price in each data frame: 
